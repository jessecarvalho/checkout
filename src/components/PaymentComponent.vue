<template>
    <div id="payment" class="md:w-1/2 m-auto mt-4 border border-gray-300 rounded-md p-5 items-center">
        <div class="md:w-4/5 m-auto grid grid-cols-3 gap-3 items-center">
            <div class="text-center md:text-left flex flex-col md:flex-row gap-2 border-2 border-gray-400 p-2 rounded-md cursor-pointer items-center justify-center h-28 md:h-16 hover:border-orange-400 hover:bg-orange-100 hover:text-white" :class="{'bg-orange-100': !this.creditCard}" @click="toggleCreditCard">
            ...
            <div class="text-center md:text-left flex flex-col md:flex-row gap-2 border-2 border-gray-400 p-2 rounded-md cursor-pointer items-center justify-center h-28 md:h-16 hover:border-orange-400 hover:bg-orange-100" :class="{'bg-orange-100': !this.pix}" @click="togglePix">
            ...
            <div class="text-center md:text-left flex flex-col md:flex-row gap-2 border-2 border-gray-400 p-2 rounded-md cursor-pointer items-center justify-center h-28 md:h-16 hover:border-orange-400 hover:bg-orange-100" :class="{'bg-orange-100': !this.ticket}" @click="toggleTicket">
        ...
        <credit-card-component :hidden="this.creditCard"></credit-card-component>
        <pix-component :hidden="this.pix"></pix-component>
        <ticket-component :hidden="this.ticket"></ticket-component>
        ...
        <div class="checkout mt-5">
            ...
            <button class="w-full md:w-fit md:px-28 py-3 bg-orange-400 text-white cursor-pointer mt-5">Comprar Agora</button>
            <div class="flex items-center justify-center">
                <img src="@/assets/image/secure.png" alt="Seguro" class="w-48 mt-5">
            </div>
        </div>
    </div>
</template>
