<template>
    <div id="payment" class="w-1/2 m-auto mt-4 border border-gray-300 rounded-md p-5 items-center">

        <div class="w-4/5 m-auto grid grid-cols-3 gap-3 items-center">
            <div class="flex flex-row gap-2 border-2 border-gray-400 p-2 rounded-md cursor-pointer items-center justify-center h-16 hover:border-orange-400 hover:bg-orange-100 hover:text-white">
            ...
            <div class="flex flex-row gap-2 border-2 border-gray-400 p-2 rounded-md cursor-pointer items-center justify-center h-16 hover:border-orange-400 hover:bg-orange-100">
        ...
        <div class="checkout mt-5">
            ...
            <button class="px-28 py-3 bg-orange-400 text-white cursor-pointer mt-5">Comprar Agora</button>
